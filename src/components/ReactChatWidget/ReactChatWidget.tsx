...
export function ReactChatWidget() {
  return (
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col w-[480px] h-[640px]">
      <header className="rounded-t-lg px-4 py-2 flex justify-between border-b bg-background border-gray-400">
      ...
      <footer className="rounded-b-lg px-4 py-2 bg-background border-t border-gray-400 flex">
        {/* todo akicha: why the default font size is so huge? */}
        {/* todo akicha: add a proper active state for the textarea */}
        <TextAreaAutoResize className="resize-none bg-background rounded-lg border border-gray-400 flex-1 h-10 px-2 py-1 text-black text-base max-h-48" />
